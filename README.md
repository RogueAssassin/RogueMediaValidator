...
The initial CI failure was caused by Ruff detecting a module-level import after the `TYPE_CHECKING` block in `app/validator.py`. The import order is corrected in this revision.
